...
<body>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">Demo</a>
			</li>
			<li><a href="#tabs-2">源码</a>
			</li>
		</ul>
		<div id="tabs-1" style="background: #fff;">
			<fieldset>
				...
				<div id="table_widget_toolbar">
					...
					标题 <input type="checkbox" name="" value="count" checked="checked" />
					计数 <input type="checkbox" name="" value="marker" checked="checked" />
					行复选框 <input type="checkbox" name="" value="filter"
						checked="checked" /> 过滤器 <input type="checkbox" name=""
						value="pager" checked="checked" /> 分页控件
				</div>
			</fieldset>
				...
				$(function() {
					...
					table
							.add({
								...
								name : 'ideawu',
								name_cn : '我',
								text : '<a href="http://www.ideawu.net/">http://www.ideawu.net/</a>',
								input : input_html
							});
					table.render();
